...
.mbl-root *{box-sizing:border-box;}
  ...
  .mbl-root /* The three "Knowing…" lines read as a stanza, .mbl-root not a paragraph */
  .opp-knowing{margin:22px 0 24px; padding-left:18px; border-left:2px solid var(--rust);}
  .mbl-root .opp-knowing span{display:block; font-size:16px; line-height:1.62; color:#3b382f;}
  .mbl-root .opp-knowing span + span{margin-top:7px;}
  .mbl-root .opp-figures{
    font-family:'Fraunces',serif; font-size:20px; font-weight:600;
    color:var(--ink); line-height:1.35; margin-bottom:18px;
  }
  .mbl-root .opp-punch{
    font-family:'Fraunces',serif; font-size:21px; font-weight:600;
    color:var(--ink); line-height:1.3; margin:22px 0 22px;
  }
  .mbl-root .opp-cta{margin-top:2px;}
  ...
  .mbl-root .reveal-copy .lead-in{
    font-family:'Fraunces',serif; font-size:21px; font-weight:600;
    color:var(--ink); line-height:1.3; margin:26px 0 18px;
  }
  .mbl-root .reveal-panel{
    background:var(--ink); color:#fff; border-radius:var(--radius);
    padding:32px; box-shadow:0 26px 60px rgba(18,32,64,.26);
  }
  .mbl-root .reveal-panel .k{
  ...
  .mbl-root .reveal-when b{font-weight:600;}
  .mbl-root .reveal-when span{color:#9aa1b8; font-size:11.5px;}
  .mbl-root .reveal-panel .btn{width:100%; justify-content:center;}
